...
public class BountyData implements java.io.Serializable {
    ...
    public BountyData(UUID uuid, boolean hasBounty, boolean hasReward, int bountyValue, int rewardValue, GameProfile gameProfile, String playerName, UUID bountier){
        this.uuid = uuid;
